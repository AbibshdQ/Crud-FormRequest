                        ...
                        <div class="card-body">
                            <form action="{{ route('office.store') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="office_address" id="office_address" class="form-control @error('office_address') is-invalid @enderror" value="{{ old('office_address') }}" maxlength="100" required>
